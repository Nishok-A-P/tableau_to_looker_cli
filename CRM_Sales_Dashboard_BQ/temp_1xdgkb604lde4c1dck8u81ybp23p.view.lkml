...
measure: won_count_percent_diff {
    ...
    type: number
    sql: ((SUM(${cm_won_count_2}) - SUM(${pm_won_count_2})) / NULLIF(SUM(${pm_won_count_2}), 0)) ;;
...
measure: percent_difference {
    ...
    type: number
    sql: ((SUM(${current_month_sales_2}) - SUM(${previous_month_sales_2})) / NULLIF(SUM(${previous_month_sales_2}), 0)) ;;
...
measure: min_max {
    ...
    type: number
    sql: CASE WHEN (SUM(${current_month_sales_2}) = 'MIGRATION_REQUIRED') THEN SUM(${current_month_sales_2}) ELSE CASE WHEN (SUM(${current_month_sales_2}) = 'MIGRATION_REQUIRED') THEN SUM(${current_month_sales_2}) ELSE NULL END END ;;
...
measure: opportunities_percent_diff {
    ...
    type: number
    sql: ((SUM(${cm_active_opportunity_kpi_2}) - SUM(${pm_active_opportunities_2})) / NULLIF(SUM(${pm_active_opportunities_2}), 0)) ;;
...
measure: gross_pipeline_percent_diff {
    ...
    type: number
    sql: ((SUM(${cm_gross_pipeline_2}) - SUM(${pm_gross_pipeline_2})) / NULLIF(SUM(${pm_gross_pipeline_2}), 0)) ;;
...
measure: won_opportunity_percent_diff {
    ...
    type: number
    sql: ((SUM(${cm_won_opportunity_2}) - SUM(${pm_won_opportunity_2})) / NULLIF(SUM(${pm_won_opportunity_2}), 0)) ;;
...
measure: cm_active_opportunity_kpi_sum_derived {
    ...
    type: number
    sql: SUM(${cm_active_opportunity_kpi_2}) ;;
...
measure: close_value_parameter_sum_derived {
    ...
    type: number
    sql: SUM(${close_value_parameter_2}) ;;
