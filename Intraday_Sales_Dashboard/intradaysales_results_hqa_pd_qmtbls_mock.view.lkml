view: intradaysales_results_hqa_pd_qmtbls_mock {
  ...
  derived_table: {
    sql:
      WITH max_table AS (SELECT MAX(`DTTM`) AS `MaxDate` FROM `tableau-to-looker-migration.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock`) SELECT base.*, max_table.`MaxDate` FROM `tableau-to-looker-migration.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` AS base CROSS JOIN `max_table` ;;
  }
...
measure: sales_sum_derived {
  ...
  dimension: channel_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([CHANNEL]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: sale_type_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([Calculation_5910989867950081]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: dttm_attribute_derived {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([DTTM]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: is_preorder_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([IS_PREORDER]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: manf_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([MANF]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: eqp_class_desc_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([eqp_class_desc]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: mkt_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([mkt]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: rpt_time_hour_trunc_derived {
    description: "Calculated field: DATETRUNC('hour', [RPT_TIME])"
    type: date_raw
    sql: DATE_TRUNC(${TABLE}.`RPT_TIME`, hour) ;;
    # Original Tableau formula: DATETRUNC('hour', [RPT_TIME])
  }

  dimension: dttm_hour_trunc_derived {
    description: "Calculated field: DATETRUNC('hour', [DTTM])"
    type: date_raw
    sql: DATE_TRUNC(${TABLE}.`DTTM`, hour) ;;
    # Original Tableau formula: DATETRUNC('hour', [DTTM])
  }
  ...
  dimension: bi_chnl_ctgry_desc_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([BI_CHNL_CTGRY_DESC]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: sales_countd_derived {
  ...
  measure: model_name_copy_count_function {
    type: count
    sql: ${TABLE}.model_name_copy_count_function ;;
    value_format_name: decimal_0
  }
