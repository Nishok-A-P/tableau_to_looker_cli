view: intradaysales_results_day_7_mock {
  ...
  sql_table_name: `tableau-to-looker-migration.Super_Store_Sales.IntradaySales_RESULTS_DAY-7_Mock` ;;
  ...
  dimension: rpt_dt_none_derived_calc {
    description: "Row-level calculation for rpt_dt_none_derived: [RPT_DT]"
    type: number
    sql: ${TABLE}.`RPT_DT` ;;
    hidden: yes
    # Original Tableau formula: [RPT_DT]
  }
...
measure: rpt_dt_none_derived {
    description: "Calculated field: [RPT_DT]"
    type: sum
    sql: ${rpt_dt_none_derived_calc} ;;
