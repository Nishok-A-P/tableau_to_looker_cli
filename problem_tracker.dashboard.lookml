- dashboard: problem_tracker
  ...
  - title: "Group Name"
    name: group_name
    model: bigquery_super_store_sales_model_generated_20250915_154310
  ...
  - title: "<Sheet Name>|"
    ...
    explore: problem_tracker_ven01911
    type: looker_column
    fields: [problem_tracker_ven01911.problem_age_seconds,
problem_tracker_ven01911.number,
problem_tracker_ven01911.priority]
    pivots: [problem_tracker_ven01911.problem_age_seconds]
    filters:
      problem_tracker_ven01911.active: true
    sorts: [problem_tracker_ven01911.problem_age_seconds,
problem_tracker_ven01911.number]
    show_value_labels: true
    show_legend: true
    x_axis_label: true
