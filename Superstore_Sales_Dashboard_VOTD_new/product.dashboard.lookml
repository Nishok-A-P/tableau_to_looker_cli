- dashboard: product
  ...
  - title: "Product Category by <"
    ...
    model: bigquery_tableau_to_bigquery_model_generated_20251104_215133
...
t2l_superstore_sales_dashboard_people_sample_superstore.percent_diff_selected_cm_vs_pm]
    sorts: [t2l_superstore_sales_dashboard_people_sample_superstore.category]
  ...
  - title: "Product Sub-Category by <"
    ...
    explore: t2l_superstore_sales_dashboard_people_sample_superstore
    type: looker_column
    fields: [t2l_superstore_sales_dashboard_people_sample_superstore.sub_category,
t2l_superstore_sales_dashboard_people_sample_superstore.percent_diff_selected_cm_vs_pm]
  ...
  - title: "Manufacturer by <[Parameters].[Parameter 4]>"
    ...
    explore: t2l_superstore_sales_dashboard_people_sample_superstore
    type: looker_column
    fields: [t2l_superstore_sales_dashboard_people_sample_superstore.percent_diff_selected_cm_vs_pm,
t2l_superstore_sales_dashboard_people_sample_superstore.manufacturer]
  ...
  - title: "Region by <"
    ...
    explore: t2l_superstore_sales_dashboard_people_sample_superstore
    type: looker_column
    fields: [t2l_superstore_sales_dashboard_people_sample_superstore.region,
t2l_superstore_sales_dashboard_people_sample_superstore.percent_diff_selected_cm_vs_pm]
    sorts: [t2l_superstore_sales_dashboard_people_sample_superstore.region]
    show_value_labels: true
    show_legend: true
    x_axis_label: true
    y_axis_label: true
...
t2l_superstore_sales_dashboard_people_sample_superstore.order_date_month_derived]
  ...
  - title: "Profit Margin(BAN)"
    ...
    explore: t2l_superstore_sales_dashboard_people_sample_superstore
    type: single_value
    fields: [t2l_superstore_sales_dashboard_people_sample_superstore.cm_profit_ratio]
    show_row_numbers: true
    table_theme: "white"
    limit: 500
    column_limit: 50
  ...
  - title: "Profit Margin(chart)"
    ...
    explore: t2l_superstore_sales_dashboard_people_sample_superstore
    type: looker_column
    fields: [t2l_superstore_sales_dashboard_people_sample_superstore.profit_ratio,
t2l_superstore_sales_dashboard_people_sample_superstore.order_date_month_derived]
    pivots: [t2l_superstore_sales_dashboard_people_sample_superstore.order_date_month_derived]
    filters:
      t2l_superstore_sales_dashboard_people_sample_superstore.year_filter: true
  ...
  - title: "Revenue(BAN)"
    ...
    explore: t2l_superstore_sales_dashboard_people_sample_superstore
    type: single_value
    fields: [t2l_superstore_sales_dashboard_people_sample_superstore.cm_revenue]
    show_row_numbers: true
    table_theme: "white"
    limit: 500
    column_limit: 50
  ...
  - title: "Revenue(chart)"
    ...
    explore: t2l_superstore_sales_dashboard_people_sample_superstore
    type: looker_column
    fields: [t2l_superstore_sales_dashboard_people_sample_superstore.revenue_sum_derived,
t2l_superstore_sales_dashboard_people_sample_superstore.order_date_month_derived]
    pivots: [t2l_superstore_sales_dashboard_people_sample_superstore.order_date_month_derived]
    filters:
      t2l_superstore_sales_dashboard_people_sample_superstore.year_filter: true
