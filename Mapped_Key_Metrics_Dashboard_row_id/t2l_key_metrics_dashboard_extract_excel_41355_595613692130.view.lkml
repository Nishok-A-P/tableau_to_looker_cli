view: t2l_key_metrics_dashboard_extract_excel_41355_595613692130 {
  ...
  dimension: cogs_calc {
    ...
    sql: 0 ;;
    hidden: yes
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ([Materials_Supplies]+[Labor]+[Production]+[Shipping]+[Returns])/1000 REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: operating_income_calc {
    ...
    sql: 0 ;;
    hidden: yes
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: [Calculation_5900401141808184]-([SGandA]/1000)-([Calculation_4340401151822284]/1000) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: net_sales_calc {
    ...
    sql: 0 ;;
    hidden: yes
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ([Gross Sales Amount]-[Sales Discounts])/1000 REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: net_profit_calc {
    ...
    sql: 0 ;;
    hidden: yes
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ([Calculation_1370401142220586])-[Taxes Interest]/1000 REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: gross_margin {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM([Calculation_5900401141808184])/SUM([Calculation_4630401141640189]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: net_profit_margin {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: Sum([Calculation_8900401142917664])/SUM([Calculation_4630401141640189]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
