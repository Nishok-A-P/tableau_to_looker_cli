...
measure: cash_ratio {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: Sum([Cash & Cash Equivalents])/Sum([Total Current Liabilities]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: quick_ratio {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: Sum([Quick Assets])/Sum([Total Current Liabilities]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: current_ratio {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: Sum([Total Current Assets])/Sum([Total Current Liabilities]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: profit_margin_percent {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: Sum([Gross Profit])/(Sum([Pump Services Revenue])+Sum([Other Revenue])+Sum([Wireline Revenue])+Sum([Workover Revenue])+Sum([Frac Revenue])) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: color {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF Sum([Gross Profit 1])<0 then '▼' end REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: net_working_capital_excl_cash_and_current_debt_copy_sum_derived {
  ...
  dimension: year_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([Year]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
