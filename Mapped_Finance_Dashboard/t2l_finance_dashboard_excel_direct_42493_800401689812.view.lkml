...
measure: number_of_records_7 {
  ...
  dimension: quarter_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([Quarter]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
