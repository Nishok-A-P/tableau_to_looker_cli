...
measure: sales_sum_derived {
  ...
  dimension: channel_attribute_derived {
    ...
    type: string
    sql: (SELECT CASE WHEN MIN(${TABLE}.`CHANNEL`) IS NULL THEN NULL WHEN MIN(${TABLE}.`CHANNEL`) = MAX(${TABLE}.`CHANNEL`) THEN MIN(${TABLE}.`CHANNEL`) ELSE '*' END FROM `elastic-pocs.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` as IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock) ;;
  ...
  dimension: sale_type_attribute_derived {
    ...
    type: string
    sql: (SELECT CASE WHEN MIN(${sale_type}) IS NULL THEN NULL WHEN MIN(${sale_type}) = MAX(${sale_type}) THEN MIN(${sale_type}) ELSE '*' END FROM `elastic-pocs.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` as IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock) ;;
  ...
  dimension: dttm_attribute_derived {
    ...
    type: date
    sql: (SELECT CASE WHEN MIN(${TABLE}.`DTTM`) IS NULL THEN NULL WHEN MIN(${TABLE}.`DTTM`) = MAX(${TABLE}.`DTTM`) THEN MIN(${TABLE}.`DTTM`) ELSE '*' END FROM `elastic-pocs.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` as IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock) ;;
  ...
  dimension: is_preorder_attribute_derived {
    ...
    type: string
    sql: (SELECT CASE WHEN MIN(${TABLE}.`IS_PREORDER`) IS NULL THEN NULL WHEN MIN(${TABLE}.`IS_PREORDER`) = MAX(${TABLE}.`IS_PREORDER`) THEN MIN(${TABLE}.`IS_PREORDER`) ELSE '*' END FROM `elastic-pocs.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` as IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock) ;;
  ...
  dimension: manf_attribute_derived {
    ...
    type: string
    sql: (SELECT CASE WHEN MIN(${TABLE}.`MANF`) IS NULL THEN NULL WHEN MIN(${TABLE}.`MANF`) = MAX(${TABLE}.`MANF`) THEN MIN(${TABLE}.`MANF`) ELSE '*' END FROM `elastic-pocs.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` as IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock) ;;
  ...
  dimension: eqp_class_desc_attribute_derived {
    ...
    type: string
    sql: (SELECT CASE WHEN MIN(${TABLE}.`eqp_class_desc`) IS NULL THEN NULL WHEN MIN(${TABLE}.`eqp_class_desc`) = MAX(${TABLE}.`eqp_class_desc`) THEN MIN(${TABLE}.`eqp_class_desc`) ELSE '*' END FROM `elastic-pocs.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` as IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock) ;;
  ...
  dimension: mkt_attribute_derived {
    ...
    type: string
    sql: (SELECT CASE WHEN MIN(${TABLE}.`mkt`) IS NULL THEN NULL WHEN MIN(${TABLE}.`mkt`) = MAX(${TABLE}.`mkt`) THEN MIN(${TABLE}.`mkt`) ELSE '*' END FROM `elastic-pocs.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` as IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock) ;;
  ...
  dimension: bi_chnl_ctgry_desc_attribute_derived {
    ...
    type: string
    sql: (SELECT CASE WHEN MIN(${TABLE}.`BI_CHNL_CTGRY_DESC`) IS NULL THEN NULL WHEN MIN(${TABLE}.`BI_CHNL_CTGRY_DESC`) = MAX(${TABLE}.`BI_CHNL_CTGRY_DESC`) THEN MIN(${TABLE}.`BI_CHNL_CTGRY_DESC`) ELSE '*' END FROM `elastic-pocs.Super_Store_Sales.IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock` as IntradaySales_RESULTS_HQA_PD_QMTBLS_Mock) ;;
...
measure: longitude_avg_derived {
  ...
  dimension: rpt_hour_none_derived {
    description: "Calculated field: [rpt_hour]"
    type: number
    sql: ${TABLE}.`rpt_hour` ;;
    # Original Tableau formula: [rpt_hour]
  }
