- dashboard: apple_summary
  ...
  - title: "By Hour"
    ...
    type: looker_column
    fields: [intradaysales_results_hqa_pd_qmtbls_mock.dttm,
...
intradaysales_results_hqa_pd_qmtbls_mock.calculation_5910989867950081,
intradaysales_results_hqa_pd_qmtbls_mock.is_preorder,
intradaysales_results_hqa_pd_qmtbls_mock.manf,
...
intradaysales_results_hqa_pd_qmtbls_mock.manf,
intradaysales_results_hqa_pd_qmtbls_mock.rolling_24_copy_1343198652312211458,
intradaysales_results_hqa_pd_qmtbls_mock.rolling_36_copy_777433916925095938,
...
intradaysales_results_hqa_pd_qmtbls_mock.total_sales]
    filters:
      ...
      intradaysales_results_hqa_pd_qmtbls_mock.rolling_24: true
    sorts: [intradaysales_results_hqa_pd_qmtbls_mock.model_name_copy desc]
    limit: 500
    column_limit: 5
    row: 14
    col: 12
