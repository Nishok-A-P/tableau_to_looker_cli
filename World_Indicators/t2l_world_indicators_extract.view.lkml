view: t2l_world_indicators_extract {
  # Generated from Tableau view: T2L_World_Indicators_Extract
  sql_table_name: `tableau-to-looker-migration.Tableau_To_BigQuery.T2L_World_Indicators_Extract` ;;
