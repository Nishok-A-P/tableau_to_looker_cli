...
explore: t2l_colour_usage_in_sales_dashboards_orders_sample_superstore {
  ...
  join: t2l_colour_usage_in_sales_dashboards_people_sample_superstore {
    type: inner
    sql_on: ${t2l_colour_usage_in_sales_dashboards_orders_sample_superstore.region} = ${t2l_colour_usage_in_sales_dashboards_people_sample_superstore.region_1} ;;
    relationship: many_to_one
  }
  join: t2l_colour_usage_in_sales_dashboards_returns_sample_superstore {
    type: inner
    sql_on: ${t2l_colour_usage_in_sales_dashboards_orders_sample_superstore.order_id} = ${t2l_colour_usage_in_sales_dashboards_returns_sample_superstore.order_id_1} ;;
    relationship: many_to_one
  }
}
