- dashboard: device_breakdown
  ...
  - title: "<"
    ...
    filters:
      ...
      setupgo_test.region: -NULL
      setupgo_test.territory: Best Buy Exclusive - Atlantic North, Best Buy Exclusive - Pacific, Retail Agent Proof of Concept, -NULL
      ...
      setupgo_test.Top/Bottom 5 (TR) (copy)_388435489321582607: Bottom 5, Top 5
...
setupgo_test.None]
    ...
    filters:
      ...
      setupgo_test.region: -NULL
      setupgo_test.outlet_name: -NULL
      setupgo_test.suag_item_cd: -NULL
      setupgo_test.territory: Best Buy Exclusive - Atlantic North, Best Buy Exclusive - Pacific, Retail Agent Proof of Concept, -NULL
