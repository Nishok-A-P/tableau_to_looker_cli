...
setupgo_test.revenue_md,
setupgo_test.revenue_single,
setupgo_test.su_g_md_other_lines,
setupgo_test.su_g_md,
setupgo_test.total_suag_den,
setupgo_test.suag_num_new,
setupgo_test.su_g_single,
...
setupgo_test.lines_per_md]
  ...
  - title: "Take Rate By Device Group"
    ...
    explore: setupgo_test
    type: looker_column
    fields: [setupgo_test.suag_num_new,
setupgo_test.None]
    filters:
      setupgo_test.date_selection_true: true
  ...
  - title: "Take Rate & Sales By Device"
    ...
    explore: setupgo_test
    type: looker_column
    fields: [setupgo_test.total_suag_net_sales,
setupgo_test.take_rate_percent,
