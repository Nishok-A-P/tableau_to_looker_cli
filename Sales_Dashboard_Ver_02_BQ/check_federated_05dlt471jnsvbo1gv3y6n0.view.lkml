...
measure: metric_selection {
    ...
    type: number
    sql: CASE WHEN ({% parameter parameter_1 %} = 'Quantity') THEN SUM(${TABLE}.`Quantity`) WHEN ({% parameter parameter_1 %} = 'Sales') THEN SUM(${TABLE}.`TotalSales`) WHEN ({% parameter parameter_1 %} = 'Profit') THEN SUM(${TABLE}.`Profit`) WHEN ({% parameter parameter_1 %} = 'Discount') THEN AVG(${TABLE}.`Discount`) WHEN ({% parameter parameter_1 %} = 'Orders') THEN ${orders} WHEN ({% parameter parameter_1 %} = 'Price') THEN AVG(${TABLE}.`Price`) WHEN ({% parameter parameter_1 %} = 'Shipping Cost') THEN AVG(${TABLE}.`ShippingCost`) WHEN ({% parameter parameter_1 %} = 'Returns') THEN SUM(${TABLE}.`ReturnedQuantity`) WHEN ({% parameter parameter_1 %} = 'Discount/Unit') THEN ${discount_unit} WHEN ({% parameter parameter_1 %} = 'Profit/Unit') THEN ${profit_unit} WHEN ({% parameter parameter_1 %} = 'Shipping/Unit') THEN ${shipping_cost_unit} END ;;
...
measure: metric_selection_vs {
    ...
    type: number
    sql: CASE WHEN ({% parameter metric_copy_365636014113275916 %} = 'Quantity') THEN SUM(${TABLE}.`Quantity`) WHEN ({% parameter metric_copy_365636014113275916 %} = 'Sales') THEN SUM(${TABLE}.`TotalSales`) WHEN ({% parameter metric_copy_365636014113275916 %} = 'Profit') THEN SUM(${TABLE}.`Profit`) WHEN ({% parameter metric_copy_365636014113275916 %} = 'Discount') THEN AVG(${TABLE}.`Discount`) WHEN ({% parameter metric_copy_365636014113275916 %} = 'Orders') THEN ${orders} WHEN ({% parameter metric_copy_365636014113275916 %} = 'Price') THEN AVG(${TABLE}.`Price`) WHEN ({% parameter metric_copy_365636014113275916 %} = 'Shipping Cost') THEN AVG(${TABLE}.`ShippingCost`) WHEN ({% parameter metric_copy_365636014113275916 %} = 'Returns') THEN SUM(${TABLE}.`ReturnedQuantity`) WHEN ({% parameter metric_copy_365636014113275916 %} = 'Discount/Unit') THEN ${discount_unit} WHEN ({% parameter metric_copy_365636014113275916 %} = 'Profit/Unit') THEN ${profit_unit} WHEN ({% parameter metric_copy_365636014113275916 %} = 'Shipping/Unit') THEN ${shipping_cost_unit} END ;;
