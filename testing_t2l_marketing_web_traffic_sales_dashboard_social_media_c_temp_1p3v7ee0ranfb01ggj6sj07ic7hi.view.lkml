...
measure: click_through_rate {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM([Clicks__c])/SUM([Impressions__c]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: click_through_percent_chg_test {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ( sum([Likes CY (copy)_1799188053620777015]) - sum([Click Through Rate CY (test) (copy)_1799188053629853756]) ) / sum([Click Through Rate CY (test) (copy)_1799188053629853756]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: market_spend_py2 {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: if DATETRUNC('year', [Date__c]) = [Calculation_1799188053658202179] THEN [Market_Spend__c] END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: market_spend_percent_chg_vs_py {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ( SUM([Calculation_621496750473269259])-SUM([Calculation_621496750473957388]) ) / SUM([Calculation_621496750473957388]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: click_through_rate_percent_chg_vs_py {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ( SUM([Click_Through_Rate_2020__c])-SUM([Click_Through_Rate_2019__c]) ) / (SUM([Click_Through_Rate_2019__c])) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: likes_percent_chg_vs_py {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ( SUM([Clicks CY (copy)_621496750479859734])-SUM([Clicks PY (copy)_621496750479859735]) ) / SUM([Clicks PY (copy)_621496750479859735]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: shares_percent_chg_vs_py {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ( SUM([Comments CY (copy)_621496750483165212])-SUM([Comments PY (copy)_621496750483165213]) ) / SUM([Comments PY (copy)_621496750483165213]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: clicks_percent_chg_vs_py {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ( SUM([Impressions CY (copy)_621496750479061011])-SUM([Impressions PY (copy)_621496750479061012]) ) / SUM([Impressions PY (copy)_621496750479061012]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: comments_percent_chg_vs_py {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ( SUM([Likes CY (copy)_621496750481403929])-SUM([Likes PY (copy)_621496750481403930]) ) / SUM([Likes PY (copy)_621496750481403930]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: impressions_percent_chg_vs_py {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ( SUM([Market Spend CY (copy)_621496750476427278])-SUM([Market Spend PY (copy)_621496750476427279]) ) / SUM([Market Spend PY (copy)_621496750476427279]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: market_spend_cy_test {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: if DATETRUNC('year', [Date__c]) = [Calculation_1799188053659418692] THEN [Market_Spend__c] END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
