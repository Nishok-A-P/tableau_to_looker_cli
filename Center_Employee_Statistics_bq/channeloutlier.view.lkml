view: channeloutlier {
  ...
  dimension: inb_aht_sec_threshold_attribute_derived_calc {
    ...
    type: number
    sql: ANY_VALUE(${inb_aht_sec_threshold_calc}) ;;
    hidden: yes
  ...
  dimension: inb_transfer_percent_threshold_attribute_derived_calc {
    ...
    type: number
    sql: ANY_VALUE(${inb_transfer_percent_threshold_calc}) ;;
    hidden: yes
  ...
  dimension: sales_time_percent_threshold_attribute_derived_calc {
    ...
    type: number
    sql: ANY_VALUE(${sales_time_percent_threshold_calc}) ;;
    hidden: yes
  ...
  dimension: inb_hold_percent_threshold_attribute_derived_calc {
    ...
    type: number
    sql: ANY_VALUE(${inb_hold_percent_threshold_calc}) ;;
    hidden: yes
  ...
  dimension: box_close_percent_threshold_attribute_derived_calc {
    ...
    type: number
    sql: ANY_VALUE(${box_close_percent_threshold_calc}) ;;
    hidden: yes
