...
measure: overall_atlow_avg_derived {
    ...
    type: number
    sql: AVG(${overall_atlow_calc}) ;;


    # Original Tableau formula: AVG([Calculation_308496623046221825])
  }

measure: credit_apps_at_low_avg_derived {
...
measure: g_pvs_budget_at_low_avg_derived {
...
measure: np_completion_at_low_avg_derived {
...
measure: np_tx_accepted_at_low_avg_derived {
...
measure: turnover_at_low_avg_derived {
...
measure: overall_btlow_avg_derived {
    ...
    type: number
    sql: AVG(${overall_btlow_calc}) ;;


    # Original Tableau formula: AVG([Calculation_308496623046828035])
  }

measure: credit_apps_bt_low_avg_derived {
...
measure: g_pvs_budget_bt_low_avg_derived {
...
measure: np_completion_bt_low_avg_derived {
...
measure: np_tx_accepted_bt_low_avg_derived {
...
measure: turnover_bt_low_avg_derived {
...
measure: overall_otlow_avg_derived {
    ...
    type: number
    sql: AVG(${overall_otlow_calc}) ;;


    # Original Tableau formula: AVG([Calculation_308496623046778882])
  }

measure: credit_apps_ot_low_avg_derived {
...
measure: g_pvs_budget_ot_low_avg_derived {
...
measure: np_completion_ot_low_avg_derived {
...
measure: np_tx_accepted_ot_low_avg_derived {
...
measure: turnover_ot_low_avg_derived {
...
measure: overall_sat_avg_derived {
    ...
    type: number
    sql: AVG(${overall_sat_calc}) ;;


    # Original Tableau formula: AVG([Calculation_308496623042527232])
  }

measure: credit_apps_sat_avg_derived {
...
measure: g_pvs_budget_sat_avg_derived {
...
measure: np_completion_sat_avg_derived {
...
measure: np_tx_accepted_sat_avg_derived {
...
measure: turnover_sat1_avg_derived {
...
measure: ebitd_avs_bud_at_low_avg_derived {
...
measure: ebitd_avs_bud_bt_low_avg_derived {
...
measure: ebitd_avs_bud_ot_low_avg_derived {
...
measure: ebitd_avs_bud_sat_avg_derived {
