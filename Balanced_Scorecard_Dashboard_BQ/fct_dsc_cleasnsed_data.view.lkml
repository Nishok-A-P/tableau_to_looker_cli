view: fct_dsc_cleasnsed_data {
  ...
  dimension: placeholder_calc {
    description: "Row-level calculation for placeholder: Min(0)"
    type: number
    sql: MIN(0) ;;
    hidden: yes
  ...
  dimension: 1_calc {
    description: "Row-level calculation for 1: Avg(1)"
    type: number
    sql: AVG(1) ;;
    hidden: yes
  ...
  dimension: 2_calc {
    description: "Row-level calculation for 2: Min(30)"
    type: number
    sql: MIN(30) ;;
    hidden: yes
