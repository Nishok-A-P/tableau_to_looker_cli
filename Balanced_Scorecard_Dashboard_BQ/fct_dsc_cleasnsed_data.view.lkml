view: fct_dsc_cleasnsed_data {
  ...
  dimension: calculation_853432193644322828 {
    description: "MIGRATION ERROR - Manual conversion required"
    type: string
    sql: 'MIGRATION_REQUIRED' ;;
    # MIGRATION_ERROR: Could not convert calculated field ORIGINAL_FORMULA: IF [Calculation_853432193643671558] THEN '| ' + IF [Calculation_853432193644064777] IN ('POP','PNR','SPC','ASC','MCD') THEN 'Dr. ' + [Calculation_853432193644249099] ELSE [Calculation_853432193644179466] + ' ' + [Calculation_853432193644249099] END END CONVERSION_ERROR: No AST data available - formula parsing may have failed TODO: Manual migration required - please convert this formula manually
  }
