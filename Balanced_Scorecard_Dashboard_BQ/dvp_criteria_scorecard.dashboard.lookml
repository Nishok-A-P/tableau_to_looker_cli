- dashboard: dvp_criteria_scorecard
  ...
  - title: "Net Promoter Score"
    name: dvp_nps
    model: bigquery_super_store_sales_model_generated_20250918_104516
...
fct_dsc_cleasnsed_data.division_vp]
    ...
    filters:
      fct_dsc_cleasnsed_data.timing_parameter: true
      fct_dsc_cleasnsed_data.month_parameter: true
      fct_dsc_cleasnsed_data.dvp_scores_officeto: -NULL, NULL, NUll
      fct_dsc_cleasnsed_data.territory_ebitda_filter: -NULL
...
fct_dsc_cleasnsed_data.division_vp]
    ...
    filters:
      fct_dsc_cleasnsed_data.timing_parameter: true
      fct_dsc_cleasnsed_data.month_parameter: true
      fct_dsc_cleasnsed_data.dvp_scores_completion: -NULL
      fct_dsc_cleasnsed_data.territory_ebitda_filter: -NULL
...
fct_dsc_cleasnsed_data.division_vp]
    ...
    filters:
      fct_dsc_cleasnsed_data.timing_parameter: true
      fct_dsc_cleasnsed_data.month_parameter: true
      fct_dsc_cleasnsed_data.dvp_scores_credit_apps: -NULL, NUll
      fct_dsc_cleasnsed_data.territory_ebitda_filter: -NULL
...
fct_dsc_cleasnsed_data.division_vp]
    ...
    filters:
      fct_dsc_cleasnsed_data.timing_parameter: true
      fct_dsc_cleasnsed_data.month_parameter: true
      fct_dsc_cleasnsed_data.dvp_scores_np_tx_accepted: -NULL
      fct_dsc_cleasnsed_data.territory_ebitda_filter: -NULL
...
fct_dsc_cleasnsed_data.division_vp]
    ...
    filters:
      fct_dsc_cleasnsed_data.timing_parameter: true
      fct_dsc_cleasnsed_data.month_parameter: true
      fct_dsc_cleasnsed_data.overall_dvp_score: -NULL
      fct_dsc_cleasnsed_data.territory_ebitda_filter: -NULL
