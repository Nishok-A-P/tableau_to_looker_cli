...
setupgo_test.total_rev_run_para]
    filters:
...
setupgo_test.rpt_mth_date]
  ...
  - title: "Line Revenue"
    ...
    explore: setupgo_test
    type: looker_scatter
    fields: [setupgo_test.total_rev_run_para,
setupgo_test.rpt_mth_month]
    ...
    table_theme: "white"
    series_point_styles:
      setupgo_test.total_rev_run_para: "square"
    x_axis_zoom: false
    y_axis_zoom: false
...
setupgo_test.military_ind,
setupgo_test.priority_ind,
setupgo_test.total_revenue_run_rate,
setupgo_test.total_rev_run_para]
    filters:
      setupgo_test.rpt_mth: 202504
    sorts: [setupgo_test.rpt_mth_date,
setupgo_test.market_copy]
  ...
  - title: "Top <"
    ...
    explore: setupgo_test
    type: looker_bar
    fields: [setupgo_test.total_top_bottom_5,
setupgo_test.ranking_granularity,
setupgo_test.total_revenue]
    pivots: [setupgo_test.total_top_bottom_5]
    stacking: normal
    filters:
      setupgo_test.rpt_mth: 202504
      setupgo_test.top_bottom_5: top 5
    sorts: [setupgo_test.total_top_bottom_5,
setupgo_test.ranking_granularity]
    show_legend: true
    x_axis_label: true
    y_axis_label: true
...
setupgo_test.sls_outlet_nm,
setupgo_test.territory,
setupgo_test.total_take_rate_percent]
    filters:
      setupgo_test.rpt_mth: 202504
    sorts: [setupgo_test.rpt_mth_month,
setupgo_test.rpt_mth_date]
  ...
  - title: "Line Tr"
    ...
    explore: setupgo_test
    type: looker_area
    fields: [setupgo_test.total_take_rate_percent,
setupgo_test.rpt_mth_month]
    filters:
      setupgo_test.rpt_mth_year: 2024
    sorts: [setupgo_test.rpt_mth_month]
...
setupgo_test.military_ind,
setupgo_test.priority_ind,
setupgo_test.total_take_rate_target,
setupgo_test.total_take_rate_percent]
    filters:
      setupgo_test.rpt_mth: 202504
    sorts: [setupgo_test.rpt_mth_date,
setupgo_test.market_copy]
  ...
  - title: "Top <"
    ...
    explore: setupgo_test
    type: looker_bar
    fields: [setupgo_test.total_top_bottom_5_tr,
setupgo_test.ranking_granularity,
setupgo_test.total_take_rate_percent]
    pivots: [setupgo_test.total_top_bottom_5_tr]
    stacking: normal
    filters:
      setupgo_test.rpt_mth: 202504
      setupgo_test.top_bottom_5_tr: top 5
    sorts: [setupgo_test.total_top_bottom_5_tr,
setupgo_test.ranking_granularity]
    show_legend: true
    x_axis_label: true
    y_axis_label: true
...
setupgo_test.sls_outlet_nm,
setupgo_test.territory,
setupgo_test.total_suag_ris_percent]
    filters:
      setupgo_test.rpt_mth: 202504
    sorts: [setupgo_test.rpt_mth_month,
setupgo_test.rpt_mth_date]
  ...
  - title: "Line Mva"
    ...
    explore: setupgo_test
    type: looker_area
    fields: [setupgo_test.total_suag_ris_percent,
setupgo_test.rpt_mth_month]
    filters:
      setupgo_test.rpt_mth_year: 2024
    sorts: [setupgo_test.rpt_mth_month]
...
setupgo_test.market_copy]
  ...
  - title: "Top <"
    ...
    explore: setupgo_test
    type: looker_bar
    fields: [setupgo_test.total_top_bottom_5_ris,
setupgo_test.ranking_granularity,
setupgo_test.total_suag_ris_percent]
    pivots: [setupgo_test.total_top_bottom_5_ris]
    stacking: normal
    filters:
      setupgo_test.rpt_mth: 202504
      setupgo_test.top_bottom_5_ris: top 5
    sorts: [setupgo_test.total_top_bottom_5_ris,
setupgo_test.ranking_granularity]
    show_legend: true
    x_axis_label: true
    y_axis_label: true
...
setupgo_test.region,
setupgo_test.territory,
setupgo_test.total_calculation_1307169799376728065,
setupgo_test.total_take_rate_percent,
setupgo_test.total_suag_ris_percent,
setupgo_test.total_rev_run_para]
    filters:
