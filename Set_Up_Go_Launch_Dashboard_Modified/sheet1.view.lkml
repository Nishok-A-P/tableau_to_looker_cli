view: sheet1 {
  ...
  dimension: percentdifference_mva_calc {
    ...
    type: number
    sql: ((${selected_month_mva} / ${previous_month_mva}) - 1) ;;
    hidden: yes
  ...
  dimension: percentdifference_tr_calc {
    ...
    type: number
    sql: ((${selected_month_take_rate} / ${previous_month_take_rate}) - 1) ;;
    hidden: yes
  ...
  dimension: md_all_in_calc {
    ...
    type: number
    sql: CASE WHEN (NOT ${TABLE}.suag_item_cd = 'C3518') THEN ${suag_num_new} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: top_bottom_5_calc {
    ...
    type: number
    sql: CASE WHEN (${index} < 6) THEN 'top 5' ELSE CASE WHEN ((${size} - ${index}) < 5) THEN 'bottom 5' ELSE 'others' END END ;;
    hidden: yes
  ...
  dimension: rev_run_calc {
    ...
    type: number
    sql: CASE WHEN ATTR(${is_current_month}) THEN ${revenue_run_rate} ELSE ${revenue} END ;;
    hidden: yes
  ...
  dimension: selected_month_sales_calc {
    ...
    type: number
    sql: CASE WHEN ((EXTRACT(MONTH FROM ${TABLE}.rpt_mth) = {% parameter current_month_copy_978688514361458693 %}) AND (EXTRACT(YEAR FROM ${TABLE}.rpt_mth) = {% parameter parameter_1 %})) THEN ${suag_num_new} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: suag_ris_percent_calc {
    ...
    type: number
    sql: (${ris_num_suag} / ${ris_denom_suag}) ;;
    hidden: yes
  ...
  dimension: selected_month_mva_den_calc {
    ...
    type: number
    sql: CASE WHEN ((EXTRACT(MONTH FROM ${TABLE}.rpt_mth) = {% parameter current_month_copy_978688514361458693 %}) AND (EXTRACT(YEAR FROM ${TABLE}.rpt_mth) = {% parameter parameter_1 %})) THEN ${mva_den} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: previous_month_mvanum_calc {
    ...
    type: number
    sql: CASE WHEN ((EXTRACT(MONTH FROM ${TABLE}.rpt_mth) = ({% parameter current_month_copy_978688514361458693 %} - 1)) AND (EXTRACT(YEAR FROM ${TABLE}.rpt_mth) = {% parameter parameter_1 %})) THEN ${mva_num} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: previous_month_mva_den_calc {
    ...
    type: number
    sql: CASE WHEN ((EXTRACT(MONTH FROM ${TABLE}.rpt_mth) = ({% parameter current_month_copy_978688514361458693 %} - 1)) AND (EXTRACT(YEAR FROM ${TABLE}.rpt_mth) = {% parameter parameter_1 %})) THEN ${mva_den} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: su_g_md_calc {
    ...
    type: number
    sql: CASE WHEN (${TABLE}.suag_item_cd = 'C65') THEN ${suag_num_new} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: su_g_single_calc {
    ...
    type: number
    sql: CASE WHEN (${TABLE}.suag_item_cd = 'C3518') THEN ${suag_num_new} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: selected_month_mva_num_calc {
    ...
    type: number
    sql: CASE WHEN ((EXTRACT(MONTH FROM ${TABLE}.rpt_mth) = {% parameter current_month_copy_978688514361458693 %}) AND (EXTRACT(YEAR FROM ${TABLE}.rpt_mth) = {% parameter parameter_1 %})) THEN ${mva_num} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: previous_month_tr_num_calc {
    ...
    type: number
    sql: CASE WHEN ((EXTRACT(MONTH FROM ${TABLE}.rpt_mth) = ({% parameter current_month_copy_978688514361458693 %} - 1)) AND (EXTRACT(YEAR FROM ${TABLE}.rpt_mth) = {% parameter parameter_1 %})) THEN ${suag_num_new} ELSE NULL END ;;
    hidden: yes
  ...
  dimension: non_suag_return_rate_calc {
    ...
    type: number
    sql: (${non_suag_returns} / ${non_suag_sales}) ;;
    hidden: yes
  ...
  dimension: top_bottom_5_copy_calc {
    ...
    type: number
    sql: CASE WHEN (${index} < 21) THEN 'top 5' ELSE CASE WHEN ((${size} - ${index}) < 5) THEN 'bottom 5' ELSE 'others' END END ;;
    hidden: yes
  ...
  measure: revenue_run_rate {
    ...
    type: number
    sql: ((SUM(${TABLE}.suag_item_revenue_amt) * ${month_length}) / ${days_in_current_month}) ;;
  ...
  dimension: su_g_indicator {
    ...
    type: string
    sql: CASE WHEN (${suag_num_new} > 0) THEN 'Y' ELSE 'N' END ;;
  ...
  dimension: mva_indicator {
    ...
    type: string
    sql: CASE WHEN (${mva_num} > 0) THEN 'Y' ELSE 'N' END ;;
  ...
  measure: percentdifference_sales {
    ...
    type: number
    sql: ((SUM(${selected_month_sales}) / SUM(${previous_month_sales})) - 1) ;;
  ...
  measure: take_rate_percent {
    ...
    type: number
    sql: (SUM(${suag_num_new}) / SUM(${TABLE}.suag_den)) ;;
  ...
  measure: sales_region {
    ...
    type: number
    sql: (SELECT SUM(${selected_month_sales}) FROM ${TABLE} GROUP BY region, ${month_day}) ;;
  ...
  measure: previous_month_mva {
    ...
    type: number
    sql: (SUM(${previous_month_mvanum}) / SUM(${previous_month_mva_den})) ;;
  ...
  measure: selected_month_mva {
    ...
    type: number
    sql: (SUM(${selected_month_mva_num}) / SUM(${selected_month_mva_den})) ;;
  ...
  measure: selected_month_revenue_copy {
    ...
    type: number
    sql: ((SUM(${selected_month_revenue}) * ${month_length}) / ${days_in_current_month}) ;;
  ...
  measure: selected_month_take_rate {
    ...
    type: number
    sql: (SUM(${selected_month_tr_num}) / SUM(${selected_month_tr_den})) ;;
  ...
  measure: previous_month_take_rate {
    ...
    type: number
    sql: (SUM(${previous_month_tr_num}) / SUM(${previous_month_tr_den})) ;;
