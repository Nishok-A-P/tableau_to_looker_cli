view: sheet1 {
  ...
  dimension: rev_run_calc {
    ...
    type: number
    sql: CASE WHEN ANY_VALUE(${is_current_month}) THEN ${revenue_run_rate_calc} ELSE ${revenue_calc} END ;;
    hidden: yes
  ...
  dimension: window_max_rev_value_calc {
    description: "Row-level calculation for window_max_rev_value: { FIXED [Calculation_619807904201347075]: [Calculation_1581607899260530688]}"
    type: number
  ...
  dimension: sales_region_calc {
    description: "Row-level calculation for sales_region: {FIXED [REGION],[Nw Year month (copy)_495114532759945223] : SUM([Calculation_978688514360860676])}"
    type: number
