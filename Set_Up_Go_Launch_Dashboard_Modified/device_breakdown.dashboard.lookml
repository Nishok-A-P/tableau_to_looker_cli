- dashboard: device_breakdown
  ...
  - title: "<"
    ...
    model: tableau_looker_poc_model_generated_20251009_164306
    explore: sheet1
    type: looker_grid
    fields: [sheet1.ranking_granularity,
sheet1.revenue_md_sum_derived,
sheet1.revenue_single_sum_derived,
sheet1.su_g_md_other_lines_sum_derived,
sheet1.su_g_md_sum_derived,
sheet1.suag_den_sum_derived,
sheet1.suag_num_new_sum_derived,
sheet1.su_g_single_sum_derived,
sheet1.revenue,
sheet1.device_revenue,
...
sheet1.lines_per_md]
    filters:
      ...
      sheet1.top_bottom_5_tr_copy: Bottom 5, Top 5
    sorts: [sheet1.ranking_granularity]
    series_colors:
      "Top 5": "#008330"
      "Others": "#136598"
      "Bottom 5": "#ee0000"
  ...
  - title: "Take Rate By Device Group"
    ...
    explore: sheet1
    type: looker_column
    fields: [sheet1.suag_num_new_sum_derived,
sheet1.None]
    filters:
      sheet1.date_selection_true: true
  ...
  - title: "Take Rate & Sales By Device"
    ...
    explore: sheet1
    type: looker_column
    fields: [sheet1.suag_net_sales_sum_derived,
sheet1.take_rate_percent,
sheet1.device_brand_nm]
    stacking: normal
    filters:
      sheet1.date_selection_true: true
    sorts: [sheet1.suag_net_sales_sum_derived]
    show_value_labels: true
    show_legend: true
    x_axis_label: true
    y_axis_label: true
...
sheet1.suag_num_new_sum_derived_2]
