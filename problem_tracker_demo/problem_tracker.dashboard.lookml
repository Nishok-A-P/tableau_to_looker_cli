- dashboard: problem_tracker
  ...
  - title: "Group Name"
    name: group_name
    model: bigquery_super_store_sales_model_generated_20250909_090957
...
problem_tracker_ven01911.count_distinct_number]
    pivots: [problem_tracker_ven01911.time_span_breakdown]
    filters:
      problem_tracker_ven01911.active: true
    sorts: [problem_tracker_ven01911.time_span_breakdown]
    show_legend: true
    x_axis_label: true
    y_axis_label: true
    limit: 500
  ...
  - title: "<Sheet Name>|"
    ...
    explore: problem_tracker_ven01911
    type: looker_column
    fields: [problem_tracker_ven01911.average_calculation_1103944901411389444,
problem_tracker_ven01911.count_distinct_number,
problem_tracker_ven01911.priority]
    pivots: [problem_tracker_ven01911.average_calculation_1103944901411389444]
    stacking: normal
    filters:
      problem_tracker_ven01911.active: true
    sorts: [problem_tracker_ven01911.average_calculation_1103944901411389444,
problem_tracker_ven01911.count_distinct_number]
    show_row_numbers: true
    table_theme: "white"
    limit: 500
