view: testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1 {
  ...
  dimension: cy_price_4_area_calc {
    ...
    sql: 0 ;;
    hidden: yes
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF [Calculation_2348908724990795782] = TRUE Then [PRICE] END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: cy_reviews_4_area_calc {
    ...
    sql: 0 ;;
    hidden: yes
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF [Calculation_2348908724990795782] = TRUE Then [NUM_REVIEWS] END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: cy_lectures_4_area_calc {
    ...
    sql: 0 ;;
    hidden: yes
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF [Calculation_2348908724990795782] = TRUE Then [NUM_LECTURES] END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: cy_student_4_area_calc {
    ...
    sql: 0 ;;
    hidden: yes
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF [Calculation_2348908724990795782] = TRUE Then [NUM_SUBSCRIBERS] END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: of_subcribers_per_price_calc {
    ...
    type: number
    sql: (
        {% if testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1.price._in_query %}
        SELECT COUNT(DISTINCT `NUM_SUBSCRIBERS`)
        FROM `tableau-to-looker-migration.Tableau_To_BigQuery.Testing_T2L_Udemy_Course_Analysis_Dashboard_VOTD_Extract_federated_0l4r2kn13ft9gm1cp0ygx1`
        WHERE `PRICE` = ${price}
        {% else %}
        SELECT COUNT(dimension_totals)
        FROM (
            SELECT ods.`PRICE`, COUNT(ods.DISTINCT `NUM_SUBSCRIBERS`) AS dimension_totals
            FROM `tableau-to-looker-migration.Tableau_To_BigQuery.Testing_T2L_Udemy_Course_Analysis_Dashboard_VOTD_Extract_federated_0l4r2kn13ft9gm1cp0ygx1` ods
            JOIN (
            SELECT DISTINCT `PRICE`
            FROM `tableau-to-looker-migration.Tableau_To_BigQuery.Testing_T2L_Udemy_Course_Analysis_Dashboard_VOTD_Extract_federated_0l4r2kn13ft9gm1cp0ygx1`
            WHERE 1=1
                {% if testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1.course_title._in_query %}
              AND `COURSE-TITLE` = ${course_title}
            {% endif %}
            {% if testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1.price_per_subcribers_bin._in_query %}
              AND `Price per subcribers (bin)` = ${price_per_subcribers_bin}
            {% endif %}
            {% if testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1.subject._in_query %}
              AND `SUBJECT` = ${subject}
            {% endif %}
            {% if testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1.is_paid._in_query %}
              AND `IS_PAID` = ${is_paid}
            {% endif %}
            {% if testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1.year._in_query %}
              AND `Year` = ${year}
            {% endif %}
            ) filtered_dimensions
            ON ods.`PRICE` = filtered_dimensions.`PRICE`
            GROUP BY ods.`PRICE`
        ) aggregated_totals
        {% endif %}
        -- LOD
...
measure: cy_price {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM(IF Year = [Parameters].[Year Parameter] THEN [PRICE] END ) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: cy_reviews {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM(IF Year = [Parameters].[Year Parameter] THEN [NUM_REVIEWS] END ) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: cy_lectures {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM(IF Year = [Parameters].[Year Parameter] THEN [NUM_LECTURES] END ) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: cy_price_4_area {
  ...
  dimension: 4_drill_1_2 {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF [Calculation_1125336997996867584] = [COURSE-TITLE] THEN 'Course-Title' ELSEIF [Calculation_1125336997996867584] = [SUBJECT] THEN 'Subject' END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: paid_percent {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: COUNT([IS_PAID]) / COUNT([COURSE_ID]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: avg_0_1 {
  ...
  dimension: subject_true_false {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF [Calculation_1114359477219618816] = True Then [SUBJECT] End REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: cy_students {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM(IF Year = [Parameters].[Year Parameter] THEN [NUM_SUBSCRIBERS] END ) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: py_students {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM(IF [Year] = [Parameters].[Year Parameter]-1 THEN [NUM_SUBSCRIBERS] END ) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: yoy_student_percent {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: [Calculation_2348908724986208257]/[Calculation_2348908724993019911] - 1 REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: price_per_students {
    ...
    type: number
    sql: (
        {% if testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1.num_subscribers._in_query %}
        SELECT AVG(`PRICE`)
        FROM `tableau-to-looker-migration.Tableau_To_BigQuery.Testing_T2L_Udemy_Course_Analysis_Dashboard_VOTD_Extract_federated_0l4r2kn13ft9gm1cp0ygx1`
        WHERE `NUM_SUBSCRIBERS` = ${num_subscribers}
        {% else %}
        SELECT AVG(dimension_totals)
        FROM (
            SELECT ods.`NUM_SUBSCRIBERS`, AVG(ods.`PRICE`) AS dimension_totals
            FROM `tableau-to-looker-migration.Tableau_To_BigQuery.Testing_T2L_Udemy_Course_Analysis_Dashboard_VOTD_Extract_federated_0l4r2kn13ft9gm1cp0ygx1` ods
            JOIN (
            SELECT DISTINCT `NUM_SUBSCRIBERS`
            FROM `tableau-to-looker-migration.Tableau_To_BigQuery.Testing_T2L_Udemy_Course_Analysis_Dashboard_VOTD_Extract_federated_0l4r2kn13ft9gm1cp0ygx1`
            WHERE 1=1
                {% if testing_t2l_udemy_course_analysis_dashboard_votd_extract_federated_0l4r2kn13ft9gm1cp0ygx1.course_title._in_query %}
              AND `COURSE-TITLE` = ${course_title}
            ...
            ON ods.`NUM_SUBSCRIBERS` = filtered_dimensions.`NUM_SUBSCRIBERS`
            GROUP BY ods.`NUM_SUBSCRIBERS`
        ) aggregated_totals
        {% endif %}
        -- LOD
    ) ;;
...
measure: percent_subs_of_each_subject {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM([NUM_SUBSCRIBERS])/ [Calculation_406449907117629441] REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: percent_price_of_each_subject {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM([PRICE])/ [Calculation_406449907132555271] REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: percent_lect_of_each_subject {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM([NUM_LECTURES])/ [Calculation_406449907138953229] REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: percent_reviews_of_each_subject {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM([NUM_REVIEWS])/ [Calculation_406449907142811671] REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: arrow_dd {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF [Table Name] = "Udemy COurse1" THEN [Calculation_530298899392446464]+ " " + [SUBJECT] ELSEIF [Subject Set] THEN [Calculation_530298899392446464]+ " " + [COURSE-TITLE] ELSE NULL END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: py_price {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM(IF [Year] = [Parameters].[Year Parameter]-1 THEN [PRICE] END ) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: py_reviews {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM(IF [Year] = [Parameters].[Year Parameter]-1 THEN [NUM_REVIEWS] END ) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: py_lectures {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM(IF [Year] = [Parameters].[Year Parameter]-1 THEN [NUM_LECTURES] END ) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
  ...
  dimension: subject_selector_for_colors {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: IF [SUBJECT] = [Parameters].[Subject Parameter] THEN [SUBJECT] END REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: yoy_price_percent_2_copy {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: [ CY Students (copy)_1653102583035305990]/[PY Students (copy)_1653102583038648327] - 1 REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: yoy_reviews_percent {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: [ CY Students (copy)_1653102583048757259]/[PY Students (copy)_1653102583048957964] - 1 REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: yoy_lectures_percent {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: [ CY Students (copy)_1653102583051632655]/[PY Students (copy)_1653102583051755536] - 1 REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
...
measure: reviews_sum_derived {
  ...
  dimension: course_title_attribute_derived {
    ...
    type: string
    sql: '' ;;
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: ATTR([COURSE-TITLE]) REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
