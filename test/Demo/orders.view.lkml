view: orders {
  ...
  dimension: square_calc {
    description: "Row-level calculation for square: FLOOR([Sales])"
    type: number
  ...
  dimension: square_and_abs_calc {
    description: "Row-level calculation for square_and_abs: SQRT(ABS([Profit]))"
    type: number
  ...
  dimension: power_calc {
    description: "Row-level calculation for power: POWER([Quantity], 2)"
    type: number
    sql: POWER(${TABLE}.quantity, 2) ;;
    hidden: yes
    # Original Tableau formula: POWER([Quantity], 2)
  }
  ...
  measure: square_and_abs {
    description: "Calculated field: SQRT(ABS([Profit]))"
    type: sum
    sql: $square_and_abs_calc ;;
    # Original Tableau formula: SQRT(ABS([Profit]))
  }

  measure: power {
    description: "Calculated field: POWER([Quantity], 2)"
    type: sum
    sql: $power_calc ;;
    # Original Tableau formula: POWER([Quantity], 2)
  }
