...
measure: profit_margin {
    ...
    # TODO: Manual conversion required - complex LOD expression ORIGINAL_FORMULA: SUM([Gross Profit])/SUM([Revenue]) *100 REASON: Complex LOD function contains IF/CASE/nested conditions and Functions
  }
